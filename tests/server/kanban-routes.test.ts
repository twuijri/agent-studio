...
const handlers = {
  ...
  schedule: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  requestReview: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  reopenReview: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
...
describe('kanban routes', () => {
  ...
  it('registers all kanban routes', async () => {
    ...
    expect(paths).toEqual(expect.arrayContaining([
      ...
      '/api/hermes/kanban/:id/schedule',
      '/api/hermes/kanban/:id/request-review',
      '/api/hermes/kanban/:id/reopen-review',
