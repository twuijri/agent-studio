...
const translations: Record<Exclude<DesktopLocale, 'ar'>, Record<TranslationKey, string>> = {
  en: {
    ...
    'agent.foldersHint': 'Commands run and files are exchanged only inside these folders.',
  ...
  zh: {
    ...
    'agent.folders': '共享文件夹',
    'agent.foldersHint': '命令仅在这些文件夹内运行，文件也仅在其中交换。',
  ...
  'zh-TW': {
    ...
    'agent.folders': '共用資料夾',
    'agent.foldersHint': '命令僅在這些資料夾內執行，檔案也僅在其中交換。',
  ...
  ja: {
    ...
    'agent.foldersHint': 'コマンドの実行とファイルの交換はこれらのフォルダー内に限られます。',
  ...
  ko: {
    ...
    'agent.folders': '공유 폴더',
    'agent.foldersHint': '명령 실행과 파일 교환은 이 폴더 안에서만 이루어집니다.',
  ...
  fr: {
    ...
    'agent.foldersHint': 'Les commandes s’exécutent et les fichiers s’échangent uniquement dans ces dossiers.',
  ...
  es: {
    ...
    'agent.foldersHint': 'Los comandos se ejecutan y los archivos se intercambian solo dentro de estas carpetas.',
  ...
  de: {
    ...
    'agent.foldersHint': 'Befehle laufen und Dateien werden nur innerhalb dieser Ordner ausgetauscht.',
  ...
  pt: {
    ...
    'agent.foldersHint': 'Os comandos são executados e os arquivos trocados apenas dentro destas pastas.',
...
const arabicTranslations: Partial<Record<TranslationKey, string>> = {
  ...
  'agent.foldersHint': 'تُنفَّذ الأوامر وتُتبادل الملفات داخل هذه المجلدات فقط.',
