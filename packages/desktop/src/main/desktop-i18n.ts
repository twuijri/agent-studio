...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show Agent Studio',
    'tray.hide': 'Hide Agent Studio',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit Agent Studio',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio is up to date.',
    'update.checkingTitle': 'Agent Studio',
    ...
    'update.availableMessage': 'Agent Studio {version} is available.',
    ...
    'update.readyMessage': 'Agent Studio {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for Agent Studio updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the Agent Studio download proxy.',
    ...
    'loginReset.confirmDetail': 'Agent Studio will restart its local Web UI service, clear login locks, and return to the login page.',
  ...
  zh: {
    ...
    'desktop.downloadCloudflareDetail': '使用 Agent Studio 下载代理。',
    ...
    'loginReset.confirmDetail': 'Agent Studio 会重启本地 Web UI 服务、清除登录失败锁，然后回到登录页。',
  ...
  'zh-TW': {
    'tray.show': '顯示 Agent Studio',
    'tray.hide': '隱藏 Agent Studio',
    'tray.checkForUpdates': '檢查更新',
    'tray.resetLogin': '重置登入',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 Agent Studio',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio 已是最新版本。',
    'update.checkingTitle': 'Agent Studio',
    ...
    'desktop.downloadCloudflareDetail': '使用 Agent Studio 下載代理。',
    ...
    'loginReset.confirmDetail': 'Agent Studio 會重新啟動本地 Web UI 服務、清除登入失敗鎖，然後回到登入頁。',
  ...
  ja: {
    'tray.show': 'Agent Studio を表示',
    'tray.hide': 'Agent Studio を隠す',
    'tray.checkForUpdates': 'アップデートを確認',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'ログイン時に開く',
    'tray.quit': 'Agent Studio を終了',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio は最新です。',
    'update.checkingTitle': 'Agent Studio',
    'update.checkingMessage': 'アップデートを確認しています...',
    'update.currentVersion': '現在のバージョン: {version}',
    'update.availableTitle': 'アップデートがあります',
    'update.availableMessage': 'Agent Studio {version} が利用できます。',
    ...
    'desktop.downloadCloudflareDetail': 'Agent Studio のダウンロードプロキシを使用します。',
  ...
  ko: {
    ...
    'update.failedMessage': 'Agent Studio 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'Agent Studio 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher Agent Studio',
    'tray.hide': 'Masquer Agent Studio',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter Agent Studio',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio est a jour.',
    'update.checkingTitle': 'Agent Studio',
    ...
    'update.availableMessage': 'Agent Studio {version} est disponible.',
    ...
    'update.readyMessage': 'Agent Studio {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de Agent Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement Agent Studio.',
  ...
  es: {
    'tray.show': 'Mostrar Agent Studio',
    'tray.hide': 'Ocultar Agent Studio',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de Agent Studio',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio esta actualizado.',
    'update.checkingTitle': 'Agent Studio',
    ...
    'update.availableMessage': 'Agent Studio {version} esta disponible.',
    ...
    'update.readyMessage': 'Agent Studio {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de Agent Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de Agent Studio.',
  ...
  de: {
    'tray.show': 'Agent Studio anzeigen',
    'tray.hide': 'Agent Studio ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'Agent Studio beenden',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio ist auf dem neuesten Stand.',
    'update.checkingTitle': 'Agent Studio',
    ...
    'update.availableMessage': 'Agent Studio {version} ist verfugbar.',
    ...
    'update.readyMessage': 'Agent Studio {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur Agent Studio konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den Agent Studio Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do Agent Studio',
    'update.upToDateTitle': 'Agent Studio',
    'update.upToDateMessage': 'Agent Studio esta atualizado.',
    'update.checkingTitle': 'Agent Studio',
    ...
    'update.availableMessage': 'Agent Studio {version} esta disponivel.',
    ...
    'update.readyMessage': 'Agent Studio {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do Agent Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do Agent Studio.',
