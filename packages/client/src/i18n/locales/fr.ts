...
jobTriggered: 'Job declenche',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Route seule — aucune condition', outputRecommended: 'Texte de réponse réussie (output, recommandé)', output: 'Texte de réponse réussie (output)', errorRecommended: 'Texte d’erreur (error, recommandé)', error: 'Texte d’erreur (error)', custom: 'Chemin personnalisé (avancé)' },
