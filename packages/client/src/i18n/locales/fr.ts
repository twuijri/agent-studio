export default {
  ...
  realtimeVoice: {
    ...
    sessionMissing: 'La conversation est indisponible.', liveTranscript: 'Transcription en direct', transcriptPlaceholder: 'Touchez le noyau vocal et commencez à parler',
