...
jobTriggered: 'Job ejecutado',
  ...
  workflow: {
    ...
    evidence: {
      ...
      checkedData: 'Datos comprobados', entireReplyText: 'Texto completo de la respuesta', errorText: 'Texto del error', jsonFieldValue: 'Valor de un campo JSON', advancedPathValue: 'Valor de la ruta avanzada', comparison: 'Comparación', textToFind: 'Texto que buscar', expectedFieldValue: 'Valor esperado del campo', parsedBusinessDecision: 'Decisión de negocio interpretada', failedGateLabel: 'Paso fallido (valor del campo failed_gate)', failedGateValue: 'Paso fallido (valor del campo failed_gate): {gate}', resizeConclusion: 'Arrastrar para cambiar la altura del resultado', decisions: { blocked: 'Bloqueado', released: 'Publicado', verified: 'Verificado', skipped: 'No requiere acción' },
    ...
    node: {
      approvalRequired: 'Aprobación tras el nodo',
