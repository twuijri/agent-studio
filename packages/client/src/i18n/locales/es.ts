...
jobTriggered: 'Job ejecutado',
  ...
  workflow: {
    ...
    evidence: {
      ...
      checkedData: 'Datos comprobados', entireReplyText: 'Texto completo de la respuesta', errorText: 'Texto del error', jsonFieldValue: 'Valor de un campo JSON', advancedPathValue: 'Valor de la ruta avanzada', comparison: 'Comparación', textToFind: 'Texto que buscar', expectedFieldValue: 'Valor esperado del campo', parsedBusinessDecision: 'Decisión de negocio interpretada', failedGateLabel: 'Paso fallido (valor del campo failed_gate)', failedGateValue: 'Paso fallido (valor del campo failed_gate): {gate}', literalTextContainsHelp: 'Comprobación literal de texto: “{value}” puede aparecer en una clave o en un valor JSON.',
