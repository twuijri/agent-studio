...
jobTriggered: 'Job ejecutado',
  ...
  workflow: {
    ...
    evidence: {
      ...
      reasons: { evaluationFailed: 'Falló la evaluación de la ruta', conditionNotMatched: 'La condición no coincidió', iterationLimitReached: 'Se alcanzó el máximo de iteraciones', routeNotMatched: 'La ruta no coincidió', businessBlocked: '«{source}» detuvo el flujo ({decision}): {reason}. Por eso no se ejecutó «{target}».', businessBlockedWithCondition: '«{source}» detuvo el flujo ({decision}): {reason}. Para continuar se requería «{expected}», pero el resultado anterior fue «{actual}». Por eso no se ejecutó «{target}».', conditionMismatchDetail: 'Para continuar se requería «{expected}», pero el resultado anterior fue «{actual}». Por eso no se ejecutó «{target}».' },
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Solo ruta — sin condición', outputRecommended: 'Texto de respuesta correcta (output, recomendado)', output: 'Texto de respuesta correcta (output)', errorRecommended: 'Texto del error (error, recomendado)', error: 'Texto del error (error)', custom: 'Ruta personalizada (avanzado)' },
