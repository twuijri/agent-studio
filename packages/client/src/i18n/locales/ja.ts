export default {
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'ルートのみ — 条件なし', outputRecommended: '成功時の応答文（output・推奨）', output: '成功時の応答文（output）', errorRecommended: '失敗時のエラー文（error・推奨）', error: '失敗時のエラー文（error）', custom: 'カスタムパス（高度）' },
