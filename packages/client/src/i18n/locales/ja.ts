...
export default {
  ...
  chat: {
    ...
    steerQueuedMessage: '実行中のランに送る',
    steerQueuedMessageLabel: '誘導',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: 'エージェントの作業中に送ったメッセージの扱い: 順番を待つ、実行を止めずに誘導する、現在のターンを中断して開始する。',
      busyInputModeQueue: 'キューに入れる',
      busyInputModeSteer: '実行を誘導',
      busyInputModeInterrupt: '中断して開始',
      theme: 'テーマ',
