...
export default {
  ekkoConfig: {
    ...
    "memoryReviewInterval": "ユーザーメッセージごとのレビュー間隔",
    ...
    "memoryReviewing": "審査中…",
    "memoryReviewPending": "審査待ち",
    "memoryReviewRetry": "審査に失敗しました。再試行待ちです",
    "memoryReviewWaitingForModel": "利用可能なモデルを待っています",
    "memoryReviewNeedsConfirmation": "ユーザー確認待ち",
    "memoryReviewNow": "審査",
    "memoryReviewFailed": "審査を開始できませんでした",
    "memoryReviewAttempt": "試行回数: {count}",
    "noReviewingMemory": "審査中のメモリはありません",
    "graphView": "関連グラフ",
    "listView": "リスト",
    "memoryNodes": "ノード",
    "memoryRelations": "関係",
