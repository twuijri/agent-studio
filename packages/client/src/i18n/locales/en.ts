...
export default {
  ekkoConfig: {
    ...
    "memoryReviewInterval": "Review every user messages",
    ...
    "memoryReviewing": "Reviewing…",
    "memoryReviewPending": "Waiting for review",
    "memoryReviewRetry": "Review failed; retry pending",
    "memoryReviewWaitingForModel": "Waiting for an available model",
    "memoryReviewNeedsConfirmation": "Waiting for user confirmation",
    "memoryReviewNow": "Review",
    "memoryReviewFailed": "Failed to start review",
    "memoryReviewAttempt": "{count} attempts",
    "noReviewingMemory": "No memories are currently under review",
    "graphView": "Graph",
    "listView": "List",
    "memoryNodes": "nodes",
  ...
  changelog: {
    ...
    new_0_6_43_4: 'Device Connections adds secure LAN and cloud App pairing, device-bound tokens, per-cloud-account isolation, entitlement checks, Docker-reachable origins, revocation status, and automatic relay recovery (#2523, #2557, #2561)',
    new_0_6_43_5: 'The App connections page now includes a responsive Android, iOS, and HarmonyOS download hub with synchronized Cloudflare and GitHub sources, download QR codes, and a direct Android APK action (#2575)',
    new_0_6_43_6: 'Group Chat adds shared speech input and an authoritative per-Agent FIFO execution queue; queued messages can be safely cancelled before execution and retracted across devices by the owning account (#2555, #2570)',
    new_0_6_43_7: 'Group Chat complete history is available from the unified History surface with stable 150-message cursor pages beyond the recent 500-message window, preserved scroll anchors, authorization, and live boundary detection (#2565, #2568)',
    new_0_6_43_8: 'Active Group Chat runs show bounded scrollable Tool lists, Tool traces remain attached to their owning Agent run, and outbound Tool results are truncated for display without changing stored or Agent-context data (#2527, #2536, #2548)',
    new_0_6_43_9: 'Group Chat hardens rolling-summary cursors, handoff depth stops, mixed self mentions, and approval or clarification fallback so concurrent, Tool-heavy, and remote-runtime conversations remain recoverable (#2511, #2519, #2525, #2569)',
    new_0_6_43_10: 'Session sidebar grouping keeps recent and pinned sessions visible in the right categories, Workflow relay behavior is corrected, and Kanban task text now follows its own left-to-right or right-to-left direction (#2546, #2545)',
    new_0_6_42_1: 'This release covers all 13 PRs merged after v0.6.41, spanning Group Chat reliability, App relay, safe queue insertion, Coding Agent maintenance, subagent routing, and MiniMax video generation',
    new_0_6_42_2: 'Group Chat keeps remote interactions routable while reducing streaming work, reliably deduplicates Agent mentions, and preserves membership and typing ownership across multiple tabs for the same account (#2473, #2495, #2498, #2500)',
    new_0_6_42_3: 'App clients can connect directly over LAN, use realtime Group Chat through App Relay, and submit native MP3 recordings to local STT (#2487, #2509)',
    new_0_6_42_4: 'Room owners can set bounded or unlimited Agent handoff depth, stop automatic chains, and grant exactly one durable continuation when more work is needed (#2504)',
    new_0_6_42_5: 'Queued messages gain a safe insert-next action for Hermes and Ekko, stopping active work only at runtime-owned model or tool boundaries and keeping state consistent across tabs (#2477)',
    new_0_6_42_6: 'Coding Agents can check npm for updates, show the latest version, install it in place, and refresh the displayed state when the update completes (#2505)',
    new_0_6_42_7: 'Recoverable Codex native stream errors no longer mark successful runs as failed, while structured Claude API failures now persist and settle exactly once (#2471, #2481)',
    new_0_6_42_8: 'Auxiliary Models adds Profile-wide subagent routing for provider, model, and reasoning effort; delegated Agents follow the main model when no override is set (#2515)',
