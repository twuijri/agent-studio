export default {
  ...
  workflow: {
    ...
    evidence: {
      ...
      checkedData: 'Checked data', entireReplyText: 'Entire reply text', errorText: 'Error text', jsonFieldValue: 'One JSON field value', advancedPathValue: 'Advanced path value', comparison: 'Comparison', textToFind: 'Text to find', expectedFieldValue: 'Expected field value', parsedBusinessDecision: 'Parsed business decision', failedGateLabel: 'Failed step (value of failed_gate)', failedGateValue: 'Failed step (value of failed_gate): {gate}', resizeConclusion: 'Drag to resize the run conclusion', decisions: { blocked: 'Blocked', released: 'Published', verified: 'Verified', skipped: 'No action needed' },
