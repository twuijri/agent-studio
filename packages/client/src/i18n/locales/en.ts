export default {
  ...
  groupChat: {
    ...
    completeHistory: 'Complete group chat history',
    readOnlyHistory: 'Read-only history',
    loadingCompleteHistory: 'Loading complete history...',
    completeHistoryLoadFailed: 'Complete group chat history could not be loaded.',
    loadingEarlierHistory: 'Loading earlier messages…',
    earlierHistoryLoadFailed: 'Earlier messages could not be loaded.',
    retryEarlierHistory: 'Retry loading earlier messages',
    earliestHistoryReached: 'You have reached the earliest message.',
