...
export default {
  ...
  browser: {
    title: 'Browser', settings: 'Browser Settings', desktopOnly: 'The embedded browser is available only in Agent Studio Desktop.', newTab: 'New Tab',
  ...
  agentManager: {
    ...
    path: 'Path',
    userCli: 'Hermes CLI',
    userCliReadonly: 'Agent Studio checks the current environment for a CLI first; CLI installations remain user managed.',
    readOnly: 'Read only',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: 'Fully quit and reopen Agent Studio after changing it. On Windows or Linux, sign out and back in if the desktop app still sees the old value.',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 and later can use the following command to update the bundled Hermes Agent only. It does not update the Agent Studio desktop app or Web UI. Fully quit Agent Studio before running:',
    webUiTitle: 'Web UI',
    platform: 'Platform',
    ...
    runtimeDirectorySaved: 'Runtime migration scheduled. Restart Agent Studio to apply it.',
    ...
    runtimeActivationFailed: 'The selected Runtime could not start, so Agent Studio used another installed version',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
    ...
    activateSuccess: 'Version selection saved. Restart Agent Studio to use it.',
  ...
  connections: {
    ...
    app: {
      ...
      downloadTitle: 'Agent Studio on your phone',
      ...
      downloadPaidDescription: 'The Agent Studio App is now officially available as a paid product. To get started, visit the pricing and purchase page, choose the plan that suits you, and complete your purchase.',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'This account does not have Agent Studio Cloud access',
  ...
  chat: {
    ...
    pushNotConfigured: 'Configure Message Push in Agent Studio “Device Connections” before enabling it.',
  ...
  models: {
    ...
    imageProvidersHint: 'Hermes providers use its image integration and require configuration. Custom providers must support Studio’s image API. Listed does not mean ready to use.',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Existing native providers remain in the Hermes profile. Web UI providers appear to Hermes as Agent Studio.',
      ...
      useHermesStudioProvider: 'Use Agent Studio provider',
