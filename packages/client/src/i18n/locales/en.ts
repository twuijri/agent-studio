...
export default {
  ...
  ekkoConfig: {
    ...
    "managed": "Core Hub managed",
    "custom": "Custom",
    "managedHint": "Core Hub-managed server definitions are injected automatically and can be edited, removed, enabled, or disabled per Profile.",
  ...
  browser: {
    title: 'Browser', settings: 'Browser Settings', desktopOnly: 'The embedded browser is available only in Core Hub Desktop.', newTab: 'New Tab',
  ...
  agentManager: {
    ...
    refresh: 'Refresh',
    hermesDescription: 'Hermes can come from a Core Hub-managed Runtime or a CLI installed by the user.',
    managedRuntime: 'Hermes Runtime',
    managedRuntimeHint: 'Core Hub installs and manages complete Runtime packages; it never installs the Hermes CLI separately.',
    studioManaged: 'Core Hub managed',
    manageRuntime: 'Manage Runtime',
    runtimeVersion: 'Runtime version',
    agentVersion: 'Hermes Agent version',
    path: 'Path',
    userCli: 'Hermes CLI',
    userCliReadonly: 'Core Hub checks the current environment for a CLI first; CLI installations remain user managed.',
    readOnly: 'Read only',
    noUserCli: 'No available Hermes CLI was detected',
    unknownVersion: 'Unknown version',
    inUse: 'In use',
    builtIn: 'Built in',
    ekkoDescription: 'Ekko ships with Core Hub and does not need separate installation, updates, or removal.',
    version: 'Version',
    codingAgentDescription: 'Core Hub can install, check for updates, and remove this Agent.',
    ...
    legacyDataMigrationDescription: 'Core Hub found data in a legacy Windows data directory. Would you like to migrate it to the current data directory?',
    legacyDataMigrationSource: 'Legacy directory',
    legacyDataMigrationTarget: 'Current directory',
    legacyDataMigrationWarning: 'Core Hub will restart after confirmation and, before local services start, overwrite matching files with the legacy copies while preserving current-only files. This question is shown only once.',
    legacyDataMigrationPositive: 'Migrate legacy data',
    legacyDataMigrationNegative: 'Do not migrate',
    legacyDataMigrationSuccess: 'Migration scheduled. Core Hub will restart and migrate the data before starting local services.',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: 'Fully quit and reopen Core Hub after changing it. On Windows or Linux, sign out and back in if the desktop app still sees the old value.',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 and later can use the following command to update the bundled Hermes Agent only. It does not update the Core Hub desktop app or Web UI. Fully quit Core Hub before running:',
    webUiTitle: 'Web UI',
    platform: 'Platform',
    ...
    runtimeDirectorySaved: 'Runtime migration scheduled. Restart Core Hub to apply it.',
    ...
    runtimeActivationFailed: 'The selected Runtime could not start, so Core Hub used another installed version',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
    ...
    activateSuccess: 'Version selection saved. Restart Core Hub to use it.',
  ...
  connections: {
    ...
    app: {
      ...
      downloadTitle: 'Core Hub on your phone',
      ...
      downloadPaidDescription: 'The Core Hub App is now officially available as a paid product. To get started, visit the pricing and purchase page, choose the plan that suits you, and complete your purchase.',
      ...
      routeDescription: 'The route used by Core Hub for cloud connections; you can switch it at any time',
      qrRouteDescription: 'The QR code identifies the Core Hub route without changing the App route',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'This account does not have Core Hub Cloud access',
  ...
  appConnections: {
    ...
    notLinked: 'Link this computer first (Devices → This computer).',
    empty: 'No apps with an MCP server were found on this computer.',
    emptyHint: 'Apps register their MCP server with Claude Desktop, Claude Code, Codex, Cursor or Windsurf; install the app’s AI integration there and rescan.',
    deviceConnected: 'Computer connected',
    deviceNotConnected: 'Computer not connected',
    shared: '{name} is now shared with the server',
    unshared: '{name} is no longer shared',
    saveFailed: 'Failed to update shared apps',
  ...
  devices: {
    ...
    linked: {
      ...
      bindingFailed: 'Failed to update the allowed profiles',
    },
    inboundStatus: {
  ...
  chat: {
    ...
    pushNotConfigured: 'Configure Message Push in Core Hub “Device Connections” before enabling it.',
    hideToolCalls: 'Hide tool calls',
    messageQueue: 'Message queue',
    removeQueuedMessage: 'Remove queued message',
    steerQueuedMessage: 'Send this into the run that is already going',
    steerQueuedMessageLabel: 'Steer',
    ...
    batchArchive: 'Archive {count} selected sessions',
    batchUnarchive: 'Unarchive {count} selected sessions',
    batchArchiveSuccess: 'Archived {count} sessions',
    batchArchivePartial: '{failed} sessions failed to archive',
    batchArchiveFailed: 'Batch archive failed',
    batchUnarchiveSuccess: 'Unarchived {count} sessions',
    batchUnarchivePartial: '{failed} sessions failed to unarchive',
  ...
  kanban: {
    ...
    message: {
      ...
      taskPromoted: 'Task promoted to ready',
  ...
  models: {
    ...
    auxiliaryProviderStudioDefault: 'Core Hub default',
    imageProvidersHermes: 'Supported in Hermes',
    imageProvidersCustom: 'Custom providers',
    imageProvidersHint: 'Hermes providers use its image integration and require configuration. Custom providers must support Core Hub’s image API. Listed does not mean ready to use.',
    ...
    auxiliaryTaskImageGeneration: 'Core Hub image generation',
    auxiliaryTaskImageEdit: 'Core Hub image-to-image',
  ...
  profiles: {
    ...
    cloneFromProfile: 'Clone from an existing profile',
    cloneSource: 'Source profile',
    cloneSourcePlaceholder: 'Select a profile to clone from',
    cloneSourceCurrent: '{name} (current)',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: 'What a message sent while the agent is working does: wait its turn, guide the run without stopping it, or stop the current turn and start it.',
      busyInputModeQueue: 'Queue it',
      busyInputModeSteer: 'Steer the run',
      busyInputModeInterrupt: 'Interrupt and start it',
      theme: 'Theme',
    ...
    voice: {
      ...
      hermesConfigDescription: 'Existing native providers remain in the Hermes profile. Web UI providers appear to Hermes as Core Hub.',
      ...
      useHermesStudioProvider: 'Use Core Hub provider',
      ...
      groqCatalogHint: 'Enter your Groq API key. Models and voices below use the documented Orpheus catalog.',
      groqVoiceHint: 'Choose an English or Saudi Arabic model, then one of its voices. Long text is split into requests of up to 200 characters and joined as WAV audio.',
