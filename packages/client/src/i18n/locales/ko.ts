...
export default {
  ekkoConfig: {
    ...
    "memoryReviewInterval": "사용자 메시지 검토 간격",
    ...
    "memoryReviewing": "검토 중…",
    "memoryReviewPending": "검토 대기 중",
    "memoryReviewRetry": "검토 실패, 재시도 대기 중",
    "memoryReviewWaitingForModel": "사용 가능한 모델 대기 중",
    "memoryReviewNeedsConfirmation": "사용자 확인 대기 중",
    "memoryReviewNow": "검토",
    "memoryReviewFailed": "검토를 시작하지 못했습니다",
    "memoryReviewAttempt": "{count}회 시도",
    "noReviewingMemory": "현재 검토 중인 메모리가 없습니다",
    "graphView": "관계 그래프",
    "listView": "목록",
    "memoryNodes": "노드",
    "memoryRelations": "관계",
