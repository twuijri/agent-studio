export default {
  ...
  realtimeVoice: {
    ...
    sessionMissing: '대화를 사용할 수 없습니다.', liveTranscript: '실시간 텍스트', transcriptPlaceholder: '음성 코어를 누르고 말해 보세요',
    ...
    hint: { idle: '중앙을 눌러 음성 턴을 시작하세요', paused: '준비되면 마이크를 다시 켜세요', listening: '자연스럽게 멈추면 전송되며 눌러서 끝낼 수도 있습니다', processing: '음성을 텍스트로 변환하고 있습니다', thinking: '현재 대화로 메시지를 보냈습니다', speaking: '언제든지 응답을 중단할 수 있습니다', error: '중앙을 눌러 다시 시도하세요' },
  },
