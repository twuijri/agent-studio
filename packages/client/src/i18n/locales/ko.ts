export default {
  ...
  groupChat: {
    ...
    completeHistory: '전체 그룹 채팅 기록',
    readOnlyHistory: '읽기 전용 기록',
    loadingCompleteHistory: '전체 기록을 불러오는 중...',
    completeHistoryLoadFailed: '전체 그룹 채팅 기록을 불러오지 못했습니다.',
    loadingEarlierHistory: '이전 메시지를 불러오는 중…',
    earlierHistoryLoadFailed: '이전 메시지를 불러오지 못했습니다.',
    retryEarlierHistory: '이전 메시지 다시 불러오기',
    earliestHistoryReached: '가장 오래된 메시지에 도달했습니다.',
    backToRoom: '방으로 돌아가기',
    enterCode: '초대 코드 입력',
    yourName: '내 이름',
  ...
  changelog: {
    ...
    new_0_6_39_1: 'Ekko가 명시적으로 초기화되고 승인으로 보호된 제한형 Node.js/Python 코드 실행을 지원하며, 포그라운드 실행을 멈추고 텍스트 또는 선택형 질문에 답을 받은 뒤 이어갈 수 있습니다(#2362, #2368)',
    ...
    new_0_6_39_4: 'Coding Agent 프롬프트를 stdin으로 전달해 여러 줄과 이미지 입력을 보존하면서 Windows 명령 길이 제한을 피합니다. Group Chat도 실행 중인 Codex, Claude 또는 Ekko 작업을 고정 2분 뒤 중단하지 않습니다(#2354, #2357)',
    ...
    new_0_6_36_6: 'Codex, Claude 및 Ekko의 workspace diff는 실시간, 복원 및 그룹 채팅에서 이를 생성한 정확한 어시스턴트 메시지에만 표시됩니다(#2264)',
    ...
    new_0_6_35_1: 'Ekko 영구 메모리가 프로덕션에서 활성화되었습니다. 프로필별로 격리된 SQLite 저장소, 4,000토큰 자동 회상 예산, 전체 메모리 관련성 검색 개선 및 더 안전한 모델 요청 처리를 제공합니다(#2246)',
    ...
    new_0_6_34_5: 'Coding Agent는 Codex, Claude 및 범위가 지정된 Provider 프로토콜 사이에서 이미지 입력을 보존하고, 지나치게 큰 Responses 도구 출력을 잘라내며, 런타임 설정과 지연 이벤트를 세션별로 격리합니다(#2222, #2232, #2238)',
    ...
    new_0_6_32_3: 'Workflow는 핸드오프와 재연결 과정에서도 각 Hermes Bridge 실행 출처를 보존하며 범위가 지정된 Codex 및 Claude 노드는 유효한 API Key 대상에 launcher 지원 프로토콜을 사용할 수 있습니다(#2137, #2154)',
