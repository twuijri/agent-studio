export default {
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: '경로만 — 조건 없음', outputRecommended: '성공 응답 텍스트 (output, 권장)', output: '성공 응답 텍스트 (output)', errorRecommended: '실패 오류 텍스트 (error, 권장)', error: '실패 오류 텍스트 (error)', custom: '사용자 경로 (고급)' },
