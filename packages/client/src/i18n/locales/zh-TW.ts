export default {
  ...
  workflow: {
    ...
    evidence: {
      ...
      checkedData: '檢查的資料', entireReplyText: '完整回覆文字', errorText: '錯誤文字', jsonFieldValue: '單一 JSON 欄位值', advancedPathValue: '進階路徑的值', comparison: '比較方式', textToFind: '要尋找的文字', expectedFieldValue: '預期欄位值', parsedBusinessDecision: '解析出的業務結論', failedGateLabel: '失敗環節（failed_gate 欄位的值）', failedGateValue: '失敗環節（failed_gate 欄位的值）：{gate}', literalTextContainsHelp: '這是字面文字檢查：「{value}」可以出現在 JSON 的 key 或 value 中。',
