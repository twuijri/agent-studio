...
export default {
  ...
  changelog: {
    ...
    new_0_6_46_4: 'Coding Agent 佇列可在安全的模型或工具邊界插入下一項任務；每個工作階段的推理強度也會跨重新整理、裝置與執行類型持久化並同步（#2667、#2671）',
    new_0_6_46_5: '工作區檔案瀏覽器現在支援 Git 狀態：檔案樹會標示變更，修改過的檔案可直接查看 Diff，預覽與編輯流程也會保留儲存庫上下文（#2674）',
    new_0_6_46_6: '瀏覽器標註現在會以結構化截圖上下文直接傳送，不再暫存於輸入框，讓單聊與群聊中的標註交接更加可靠（#2679）',
    new_0_6_46_7: 'App Relay 在本機開發時不再覆蓋桌面 Relay，可選擇自動、直連或 Relay 路由；單聊續接快照也會限制大小，讓長對話重新連線更有效率（#2682、#2683、#2696）',
    new_0_6_46_8: '停止群聊執行時會確定性地結算待處理的 Ekko 澄清要求，避免已停止的鏈路卡住或意外恢復（#2694）',
    new_0_6_45_1: '本版本涵蓋 v0.6.44 之後合併的全部 16 個 PR，重點改善推理與工具軌跡、模型和下載管理、聊天連續性、群聊草稿及整體可靠性',
    new_0_6_45_2: '即時推理和執行中工具現會維持穩定的單行顯示；完成的工具會進入帶有明確狀態和動畫的執行卡片。續聊後卡片不會消失，DeepSeek 工具續接會回傳推理內容，全域 Codex、Claude 和 Pi 則繼續由 CLI 管理模型設定（#2662）',
    new_0_6_45_3: '模型頁面新增備用鏈分頁，可為新工作階段加入、拖曳或使用鍵盤排序、移除並儲存最多 10 組備用 Provider 與模型（#2627）',
    new_0_6_45_4: 'Studio 現會從發佈清單載入可管理的 Runtime 版本，並提供行動端下載中心，透過固定 QR Code 支援 Android、Google Play、Apple 和 HarmonyOS（#2659）',
    new_0_6_45_5: '群聊草稿現會依房間分別持久化，包括結構化 Mention；切換房間、重新載入或傳送失敗後仍會保留，僅在非同步傳送成功後清除（#2643）',
    new_0_6_45_6: '聊天導覽更加可靠：桌面端切換工作階段後自動聚焦輸入框，/new 工作階段歷史保持可見，標題和大綱自動選擇文字方向，過期載入也不會再取代新聊天（#2606、#2609、#2614、#2650）',
    new_0_6_45_7: 'Coding Agent 與背景聊天的連續性獲得改善：不支援圖片的端點會被記為純文字，Pi 可在回合間續接原生工作階段，背景回呼會保留觸發時的上下文（#2655、#2656、#2657）',
    new_0_6_45_8: '控制項與錯誤訊息更加明確：推理強度會提示可拖曳的 8 個等級，排程要求明確輸入 Cron，超大檔案上傳會回傳真正的 413 原因（#2604、#2605、#2647）',
    new_0_6_45_9: '維護工作移除了 Studio 中的舊網站，並在 Node 24 下依 Worker 隔離測試狀態，減少重複發佈入口和不穩定的 CI（#2622、#2654）',
    new_0_6_44_1: '本版本涵蓋 v0.6.43 之後合併的全部 13 個 PR，重點改善群聊即時歷史與執行狀態、App 連線可靠性、模型與 Provider 使用體驗，以及 Agent Bridge 訊息持久化',
    new_0_6_44_2: '群聊現可跨房間顯示正在執行的 Agent，將更高的 Tool 面板置於對話文字上方，允許摺疊目前房間群組，並直接在即時房間中載入完整歷史（#2572、#2573、#2584、#2594）',
    new_0_6_44_3: 'App 連線現會優先使用實體區域網路位址而非 VPN 網卡，正確更新失效的 Relay 配對碼，並向行動端提供更精簡的使用者頭像資料（#2591、#2592、#2598）',
    new_0_6_44_4: '官方網站新增中英文隱私政策，說明 Google 使用者資料的存取、撤銷授權、儲存、分享及 Limited Use 要求（#2590）',
    new_0_6_44_5: '模型與 Provider 流程會在不同選擇器之間記住已摺疊的 Provider 群組；對於可正常存取但不提供模型目錄的服務，也可在明確警告後儲存，不再誤報連線失敗（#2585、#2587）',
    new_0_6_44_6: '檔案管理器現可正確處理 ..hidden 等以多個點開頭的合法檔名，同時繼續阻止真正的父目錄穿越（#2586）',
    new_0_6_44_7: 'Web UI 對話現會載入已設定的備用 Provider 鏈；主模型遇到限流等符合條件的錯誤時，可以自動切換到備用 Provider（#2599）',
    new_0_6_44_8: 'Studio 與 Hermes 共用工作階段資料庫時，聊天歷史不再重複儲存同一則使用者訊息；若提前寫入失敗，仍由原生持久化補寫，避免訊息遺失（#2601）',
    new_0_6_43_1: '本版本涵蓋 v0.6.42 之後合併的全部 19 個 PR，重點新增 Pi 與 Coding Agent 原生命令、安全 App 與裝置連線、完整群聊歷史、可取消執行佇列及多項可靠性改善',
    new_0_6_43_2: 'Pi 作為受管 Coding Agent 接入 Studio，支援 Scoped 與 Global RPC 工作階段、即時文字與推理、Studio 審批和澄清、隔離設定、延遲載入 MCP 工具、Provider 路由及原生工作階段續接（#2528）',
    new_0_6_43_3: 'Codex、Claude 與 Pi 單聊會在輸入到達 CLI 前處理 /context、/compact、/usage 與 /status；/compact 使用各 Agent 的原生壓縮，並直接回報原生失敗，不進行不安全的 Studio 回退（#2566）',
    new_0_6_43_4: '裝置連線新增安全的區域網路與雲端 App 配對、裝置綁定 Token、雲端帳號層級隔離、權益驗證、Docker 可達位址、撤銷狀態以及 Relay 自動恢復（#2523、#2557、#2561）',
    new_0_6_43_5: 'App 連線頁新增響應式 Android、iOS 與 HarmonyOS 下載中心，Cloudflare 和 GitHub 下載來源會同步切換，並提供下載 QR Code 與 Android APK 直接下載（#2575）',
    new_0_6_43_6: '群聊新增共用語音輸入和伺服器權威的按 Agent FIFO 執行佇列；尚未執行的排隊訊息可安全取消，歸屬帳號也可跨裝置撤回（#2555、#2570）',
    new_0_6_43_7: '統一歷史頁面現可查看完整群聊歷史：超出最近 500 則視窗後按穩定游標每頁載入 150 則，同時保留捲動錨點、權限驗證與即時邊界偵測（#2565、#2568）',
    new_0_6_43_8: '進行中的群聊 Run 會顯示有界可捲動 Tool 清單，Tool 軌跡始終歸屬正確的 Agent Run；對外顯示的 Tool 結果會截斷，但不影響儲存資料與 Agent 上下文（#2527、#2536、#2548）',
    new_0_6_43_9: '群聊強化滾動摘要游標、交接深度停止、混合自我提及，以及審批/澄清的 Runtime 回退，讓高併發、Tool 密集與遠端 Runtime 對話都能可靠恢復（#2511、#2519、#2525、#2569）',
    new_0_6_43_10: '工作階段側邊欄修正最近、釘選與分類群組並修復 Workflow Relay；Kanban 任務文字會依自身內容自動選擇從左到右或從右到左的方向（#2546、#2545）',
