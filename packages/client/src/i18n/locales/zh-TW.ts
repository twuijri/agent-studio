export default {
  ...
  groupChat: {
    ...
    completeHistory: '完整群聊歷史',
    readOnlyHistory: '唯讀歷史記錄',
    loadingCompleteHistory: '正在載入完整歷史...',
    completeHistoryLoadFailed: '完整群聊歷史載入失敗。',
    loadingEarlierHistory: '正在載入更早的訊息…',
    earlierHistoryLoadFailed: '更早的訊息載入失敗。',
    retryEarlierHistory: '重試載入更早訊息',
    earliestHistoryReached: '已到達最早一則訊息。',
    backToRoom: '返回群聊',
    enterCode: '輸入邀請碼',
    yourName: '你的名稱',
