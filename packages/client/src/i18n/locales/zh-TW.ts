export default {
  ...
  groupChat: {
    ...
    removeMember: '移出群聊',
    removeMemberConfirm: '確定將 {name} 移出群聊嗎？該成員帶入的 Agent 也會被移除。',
    ...
    summaryEveryTurns: '每 N 輪總結',
    summaryEveryTurnsDesc: '一輪等於一則真人訊息；總結和錨點提交後，Agent 才會開始下一輪執行。',
