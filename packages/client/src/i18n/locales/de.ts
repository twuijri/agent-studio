...
jobTriggered: 'Job ausgelost',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Nur Route — keine Inhaltsprüfung', outputRecommended: 'Erfolgreicher Antworttext (output, empfohlen)', output: 'Erfolgreicher Antworttext (output)', errorRecommended: 'Fehlertext (error, empfohlen)', error: 'Fehlertext (error)', custom: 'Eigener Pfad (erweitert)' },
