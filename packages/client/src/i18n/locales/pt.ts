...
jobTriggered: 'Job acionado',
  ...
  workflow: {
    ...
    evidence: {
      ...
      reasons: { evaluationFailed: 'Falha na avaliação do caminho', conditionNotMatched: 'A condição não correspondeu', iterationLimitReached: 'Limite máximo de iterações atingido', routeNotMatched: 'A rota não correspondeu', businessBlocked: '“{source}” interrompeu o fluxo ({decision}): {reason}. Por isso, “{target}” não foi executado.', businessBlockedWithCondition: '“{source}” interrompeu o fluxo ({decision}): {reason}. Para continuar, era necessário “{expected}”, mas o resultado anterior foi “{actual}”. Por isso, “{target}” não foi executado.', conditionMismatchDetail: 'Para continuar, era necessário “{expected}”, mas o resultado anterior foi “{actual}”. Por isso, “{target}” não foi executado.' },
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Somente rota — sem condição', outputRecommended: 'Texto da resposta com sucesso (output, recomendado)', output: 'Texto da resposta com sucesso (output)', errorRecommended: 'Texto do erro (error, recomendado)', error: 'Texto do erro (error)', custom: 'Caminho personalizado (avançado)' },
