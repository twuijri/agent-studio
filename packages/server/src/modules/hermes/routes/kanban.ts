...
kanbanRoutes.post('/api/hermes/kanban/:id/promote', ctrl.promote)
kanbanRoutes.post('/api/hermes/kanban/:id/schedule', ctrl.schedule)
kanbanRoutes.post('/api/hermes/kanban/:id/request-review', ctrl.requestReview)
kanbanRoutes.post('/api/hermes/kanban/:id/reopen-review', ctrl.reopenReview)
