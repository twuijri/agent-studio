...
deviceRoutes.get('/api/devices/bindings', ctrl.listDeviceBindingsController)
deviceRoutes.put('/api/devices/:id/bindings', ctrl.updateDeviceBindingController)
deviceRoutes.get('/api/devices/peer-connections/:connectionId/screen', ctrl.capturePeerScreen)
deviceRoutes.post('/api/devices/peer-connections/:connectionId/screen/action', ctrl.performPeerScreenAction)
