# Upstream documentation (reference only)

This file preserves the README of the upstream project,
[EKKOLearnAI/hermes-studio](https://github.com/EKKOLearnAI/hermes-studio) (Ekko Studio,
formerly Hermes Studio / Hermes Web UI), as it stood when Core Hub was forked.
It is kept for attribution and reference. Official cloud subscriptions, product
downloads, hosted services, and auto-update instructions described here are not
features of Core Hub; see the [Core Hub README](../README.md) instead.

---

Browse installed skills, read their instructions, and enable them as needed.

![Ekko Agent Skills browser showing the GitHub skill](./screenshots/overview/skills.png)
